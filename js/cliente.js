...
const cargarCliente = async () => {
    ...
    respuesta.items.forEach(element => {   
        ...
        <tr>
            ...
            <td>${element.email}</td>
            <td>${element.age}</td>            
            <td onclick="eliminarCliente(${element.id})"><i class="bi bi-trash rojo pointer" name="eliminar"></i></td>
            <td><span onclick="cargarDatosModalCliente(${element.id})" class="azul pointer" data-bs-toggle="modal" data-bs-target="#exampleModalCliente">Ver</span> <i onclick="cargarDatosModalCliente(${element.id})" class="bi bi-eye azul pointer" data-bs-toggle="modal" data-bs-target="#exampleModalCliente"></i></td>
